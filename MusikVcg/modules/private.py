...
def _start(client, message):
    client.send_message(message.chat.id,
        ...
        reply_markup=InlineKeyboardMarkup([[
            ...
            InlineKeyboardButton("📲 Join Gc", url=f"https://t.me/ChatBotXanon"), 
...
async def gstart(_, message: Message):
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("💬 Tanya tanya klik disini", url=f"https://t.me/xxsta me")]]),
    )
