...
async def ytmusic(client, message: Message):
    ...
    pablo = await client.send_message(
        message.chat.id, f"`Mencari {urlissed} dari Youtube Servers. Mohon tunggu.`"
    )
    if not urlissed:
        await pablo.edit("Perintah salah! Silahkan cek daftar perintah dengan mengetik `/help` ")
        return
